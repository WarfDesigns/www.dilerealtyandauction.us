<?php
/**
 * Module Library: FullwidthCode Module
 *
 * @package Divi
 * @since ??
 */
...
/**
 * Class FullwidthCodePresetAttrsMap
 *
 * @since ??
 *
 * @package ET\Builder\Packages\ModuleLibrary\FullwidthCode
 */
class FullwidthCodePresetAttrsMap {
	/**
	 * Get the preset attributes map for the FullwidthCode module.
	 *
	 * @since ??
	 *
	...
	public static function get_map( array $map, string $module_name ) {
		if ( 'divi/fullwidth-code' !== $module_name ) {
			return $map;
		}
