...
class BoxShadowStyle {
	...
	public static function style( $args ) {
		...
		// If attr is empty but preset exists, return minimal structure for override logic.
		// This allows BoxShadow::value() to detect preset + local 'none' and return 'none' CSS value.
