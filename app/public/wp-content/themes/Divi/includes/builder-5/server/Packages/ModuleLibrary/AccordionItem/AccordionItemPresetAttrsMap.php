<?php
/**
 * Module Library: Accordion Item Module Preset Attributes Map
 *
 * @package Divi
 * @since ??
 */
...
/**
 * Class AccordionItemPresetAttrsMap
 *
 * @since ??
 *
 * @package ET\Builder\Packages\ModuleLibrary\AccordionItem
 */
class AccordionItemPresetAttrsMap {
	/**
	 * Get the preset attributes map for the Accordion Item module.
	 *
	 * @since ??
	 *
	...
	public static function get_map( array $map, string $module_name ) {
		if ( 'divi/accordion-item' !== $module_name ) {
			return $map;
		}
