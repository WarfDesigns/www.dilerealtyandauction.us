<?php
/**
 * Module Library:Row Module Preset Attributes Map
 *
 * @package Divi
 * @since ??
 */
...
/**
 * Class RowPresetAttrsMap
 *
 * @since ??
 *
 * @package ET\Builder\Packages\ModuleLibrary\Row
 */
class RowPresetAttrsMap {
	/**
	 * Get the preset attributes map for the Row module.
	 *
	 * @since ??
	 *
	...
	public static function get_map( array $map, string $module_name ) {
		...
		$static_attrs = [
			...
			'module.advanced.gutter__width'                => [
				'attrName' => 'module.advanced.gutter',
				'preset'   => [ 'html' ],
				'subName'  => 'width',
			],
			'module.advanced.gutter__alignColumns'         => [
				'attrName' => 'module.advanced.gutter',
				'preset'   => [ 'style' ],
