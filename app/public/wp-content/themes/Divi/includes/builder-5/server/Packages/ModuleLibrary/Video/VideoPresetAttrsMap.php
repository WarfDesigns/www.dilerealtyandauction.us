<?php
/**
 * Module Library: Video Module Preset Attributes Map
 *
 * @package Divi
 * @since ??
 */
...
/**
 * Class VideoPresetAttrsMap
 *
 * @since ??
 *
 * @package ET\Builder\Packages\ModuleLibrary\Video
 */
class VideoPresetAttrsMap {
	/**
	 * Get the preset attributes map for the Video module.
	 *
	 * @since ??
	 *
