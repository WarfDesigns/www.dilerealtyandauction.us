<?php
/**
 * Module Library: FullwidthImage Module
 *
 * @package Divi
 * @since ??
 */
...
/**
 * Class FullwidthImagePresetAttrsMap
 *
 * @since ??
 *
 * @package ET\Builder\Packages\ModuleLibrary\FullwidthImage
 */
class FullwidthImagePresetAttrsMap {
	/**
	 * Get the preset attributes map for the FullwidthImage module.
	 *
	 * @since ??
	 *
	...
	public static function get_map( array $map, string $module_name ) {
		if ( 'divi/fullwidth-image' !== $module_name ) {
			return $map;
		}
		...
		$static_attrs = [
			...
			'image.advanced.lightbox'                      => [
				'attrName' => 'image.advanced.lightbox',
				'preset'   => 'content',
			],
			'image.innerContent__linkUrl'                  => [
				'attrName' => 'image.innerContent',
				'preset'   => 'content',
				'subName'  => 'linkUrl',
			],
			'image.innerContent__linkTarget'               => [
				'attrName' => 'image.innerContent',
				'preset'   => 'content',
				'subName'  => 'linkTarget',
			],
			...
			'image.advanced.overlay__use'                  => [
				'attrName' => 'image.advanced.overlay',
				'preset'   => [ 'style' ],
				'subName'  => 'use',
			],
			'image.advanced.overlayIcon__iconColor'        => [
				'attrName' => 'image.advanced.overlayIcon',
				'preset'   => [ 'style' ],
				'subName'  => 'iconColor',
			],
			'image.advanced.overlay__backgroundColor'      => [
				'attrName' => 'image.advanced.overlay',
				'preset'   => [ 'style' ],
				'subName'  => 'backgroundColor',
			],
			'image.advanced.overlayIcon__hoverIcon'        => [
				'attrName' => 'image.advanced.overlayIcon',
				'preset'   => [ 'style' ],
				'subName'  => 'hoverIcon',
			],
