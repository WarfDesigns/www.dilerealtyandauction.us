<?php
/**
 * Module Library: FullwidthPostSlider Module
 *
 * @package Divi
 * @since ??
 */
 ...
 * @since ??
 *
 * @package ET\Builder\Packages\ModuleLibrary\FullwidthPostSlider
 */
class FullwidthPostSliderPresetAttrsMap {
	/**
	 * Get the preset attributes map for the FullwidthPostSlider module.
	 *
	 * @since ??
	 *
