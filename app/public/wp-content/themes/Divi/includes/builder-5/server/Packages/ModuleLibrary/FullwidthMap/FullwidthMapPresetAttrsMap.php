<?php
/**
 * Module Library: FullwidthMap Module
 *
 * @package Divi
 * @since ??
 */
...
/**
 * Class FullwidthMapPresetAttrsMap
 *
 * @since ??
 *
...
class FullwidthMapPresetAttrsMap {
	/**
	 * Get the preset attributes map for the FullwidthMap module.
	 *
	 * @since ??
	 *
	...
	public static function get_map( array $map, string $module_name ) {
		if ( 'divi/fullwidth-map' !== $module_name ) {
			return $map;
		}
